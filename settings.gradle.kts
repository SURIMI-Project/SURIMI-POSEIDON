...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        // The repositories below (excluding "buf" above) are intentionally mirrored in
        // POSEIDON/settings.gradle.kts. Keep both lists — including comments and order — in sync.
        maven {
