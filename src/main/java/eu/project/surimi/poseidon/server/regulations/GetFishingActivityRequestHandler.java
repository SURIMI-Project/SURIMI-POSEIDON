...
public class GetFishingActivityRequestHandler extends
    ...
    public GetFishingActivityRequestHandler(final SimulationManager simulationManager) {
        super(simulationManager);
    }

    @Override
    protected String getSimulationId(final GetFishingActivityRequest request) {
        return request.getSimulationId();
    }

    @Override
    protected GetFishingActivityResponse getResponseWithSimulation(
