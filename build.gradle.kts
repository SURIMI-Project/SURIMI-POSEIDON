...
dependencies {
    ...
    implementation("build.buf.gen:surimi_surimi-protocol_grpc_java:1.81.0.1.20260514124645.ee6b72106013")
...
val buildDockerImage = tasks.register("buildDockerImage", Exec::class) {
    ...
    commandLine("docker", "build", "-t", "official-ewe/surimiposeidon:latest", ".")
}

tasks.register("pushDockerImage", Exec::class) {
    dependsOn(buildDockerImage)
    commandLine("docker", "push", "official-ewe/surimiposeidon:latest")
}
